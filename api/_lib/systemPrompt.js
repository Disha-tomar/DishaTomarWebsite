...
function buildSystemPrompt() {
  return [
    ...
    `- getPersonal for her background/career story, education, fun facts, hobbies, and interests`,
    `Call a tool whenever a question depends on her real data; do not guess or invent details.`,
    `If a personal detail (e.g. hobbies) isn't available from the tools, say you don't have that yet rather than making something up.`,
    ``,
